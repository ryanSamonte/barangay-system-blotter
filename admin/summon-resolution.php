                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown nav-li">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a href="summon-resolution.php" class="nav-link link active"><i class="fas fa-envelope"></i>&nbsp;&nbsp;Resolution</a>
                                    <div class="dropdown-divider"></div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="summon-resolution-info.php?bID=<?php echo $blotter_id; ?>" class="btn btn-primary btn-table" data-toggle="tooltip" data-placement="top" title="Generate Summon Resolution"><i class="fas fa-handshake"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
