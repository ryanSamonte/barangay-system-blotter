...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2018 at 12:24 PM
...
INSERT INTO `tbl_blotter_details` (`blotter_id`, `incident_place`, `incident_details`, `summon_date`, `summon_time`, `archive_status`, `summon_count`) VALUES
(1, 'San Rafael', 'sdjaksdasdhkajdhksa', '2018-04-16', '14:00', 0, 1),
(2, 'San Rafael', 'l;lgfggghjjlkgfdfg', 'N', 'N', 0, 0),
(3, 'P. Gabriel', 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bono', 'N', 'N', 0, 0),
(4, 'M. De Vera', 'qwertyuiopasdfghjklmnbvcxzaasdfghjklpoiuytrewqasdfghjkmnbvcxzaqazwsxdedcfrfvbgtgbnhyhnyujmikko', '2018-05-10', '15:35', 0, 0),
...
(6, 'Pitong Gatang', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dicti', 'N', 'N', 0, 0),
...
(8, 'San Rafael', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dicti', '2018-03-31', '13:00', 0, 0),
(9, 'Bumbero', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dicti', '2018-09-05', '14:00', 0, 0),
...
(15, 'San Jose', 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bono', '2018-09-05', '16:01', 0, 0),
(16, 'Pitong Gatang', 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bono', '2018-04-05', '15:00', 0, 0),
(17, 'Buraot', 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bono', '2018-04-05', '12:59', 0, 0),
...
(19, 'Gov. Pascual', 'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections 1.10.32 and 1.10.33 of \"de Finibus Bono', '2018-04-16', '17:00', 0, 2);
...
('Samonte', 'Ryan Joseph', 'Ramirez', 'M', '1996-01-01', 22, 9123444, '', '', '', 235, 'Gov. Pascual', 5, '0', 7),
('Thompson', 'Scottie', 'Earl', 'M', '1996-01-01', 22, 947474747, 'Security Guard', 'Single', 'Roman Catholic', 6, 'San Rafael', 7, '0', 8),
...
('Samonte', 'Raymharc', 'Ramirez', 'M', '2002-11-16', 16, 912345679, 'Student', 'Single', 'Roman Catholic', 235, 'Gov. Pascual', 2, '0', 11),
...
('Caguioa', 'Mark', 'Spark', 'M', '1977-03-30', 41, 912345679, 'Basketball Player', 'Single', 'Roman Catholic', 47, 'San Rafael', 2, '0', 14),
('Helterbrand', 'Jayjay', 'Fast', 'M', '1974-04-01', 43, 912345679, 'Basketball Player', 'Single', 'Roman Catholic', 13, 'P. Gabriel', 0, '1', 15),
('Helterbrand', 'Jayjay', 'Fast', 'M', '1974-04-02', 43, 912345679, 'Basketball Player', 'Single', 'Roman Catholic', 13, 'P. Gabriel', 3, '0', 16);
...
('Samonte', 'Ryan Joseph', 'Ramirez', 'F', '1999-06-01', 18, 9123444, 'ryan004', '1234', '2', '0', 'ID Pic.jpg', 6),
...
--
ALTER TABLE `tbl_complainant`
  MODIFY `complainant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `tbl_respondent`
  MODIFY `respondent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
