                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item mr-3 nav-li">
                                <a href="index.php" class="nav-link active link"><i class="fas fa-tachometer-alt"></i>&nbsp;Dashboard</a>
                            </li>
                            ...
                            <li class="nav-item mr-3 nav-li">
                                <a href="" class="nav-link link"><i class="fas fa-id-card"></i>&nbsp;Resident</a>
                            </li>
                        ...
                        <table class="table table-hover table-inverse table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($blotterrecords); ?></td>
                                    <td class="text-center"><a href="" class="btn btn-warning"><i class="far fa-edit"></i>&nbsp;Update</a>&nbsp;&nbsp;<a href="manage-resident.php?archive=<?php echo $residentid; ?>" class="btn btn-danger"><i class="far fa-file-archive"></i>&nbsp;Archive</a></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
