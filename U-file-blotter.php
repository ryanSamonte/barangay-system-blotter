...
<?php
    ...
    if(ISSET($_GET['id'])){
        ...
        if(ISSET($_POST['submit'])){
            ...
            $insertUserQuery = "INSERT INTO `tbl_family_member`(`lastname`, `firstname`, `middlename`, `gender`, `birthdate`, `age`, `contactnum`, `occupation`, `civilstatus`, `religion`, `relationship`, `housenum`, `streetname`, `archivestatus`, `blotterrecords`, `residenttype`, `householdheadid`) VALUES ('$lastname','$firstname','$middlename','$gender','$birthdateNewFormat', DATEDIFF(CURRENT_DATE(), '$birthdateNewFormat') / 365 ,'$contactnum','$occupation','$civilstatus','$religion','$relationship','$housenum','$streetname','0','0','Family Member','$householdheadid')";
    ...
    <body>
        ...
        <section id="add-family-member">
            ...
            <?php echo errorMessage(); echo successMessage(); ?>
                <div class="row">
                    <div class="col">
                        <div id="home" class="card card-table mb-5" style="padding-left:0px; padding-right:0px;">
                            <div class="card-header card-table-header">
                                <h1 class="card-title" id="exampleModalLabel">&plus; Add new family member</h1>
                            </div>
                            <div class="card-body">
                                <div class="container">
                                    <form class="needs-validation" action="add-family-member.php?id=<?php echo $householdheadid; ?>" method="post" id="add-resident-form" novalidate>
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-md-2">
                                                <label for="occupation">Age</label>
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-md-4">
                                                <label for="housenum">City</label>
                                                <input type="text" class="form-control" name="relationship" id="relationship" placeholder="e.g. Mother" required>
                                                <div class="invalid-feedback">
                                                    Required field!
                                                </div>
                                            </div>
